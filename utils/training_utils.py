...
def _get_control_longitudinal(text):
...
def eval_action(all_pred, all_label):
    ...
    for pred, label in zip(all_pred, all_label):
        pred_control_longitudinal = _get_control_longitudinal(pred)
        label_control_longitudinal = _get_control_longitudinal(label)
        pred_control_lateral = _get_control_lateral(pred)
        label_control_lateral = _get_control_lateral(label)
        if (
